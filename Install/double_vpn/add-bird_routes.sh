...
ROUTE_FORCE_ISP=/opt/etc/bird-force-isp.list
ROUTE_FORCE_VPN1=/opt/etc/bird-force-vpn1.list
ROUTE_FORCE_VPN2=/opt/etc/bird-force-vpn2.list
ROUTE_BASE_VPN1=/opt/etc/bird-base-vpn1.list
ROUTE_USER_VPN1=/opt/etc/bird-user-vpn1.list
ROUTE_BASE_VPN2=/opt/etc/bird-base-vpn2.list
ROUTE_USER_VPN2=/opt/etc/bird-user-vpn2.list
...
ipr_func $VPN2 $VPN2TXT | diff -u $ROUTE_FORCE_VPN2 - | patch $ROUTE_FORCE_VPN2 -
 ...
 #RESTART BIRD
if [ "$(cat $MD5_SUM)" != "$(md5sum /opt/etc/bird*)" ]; then
  md5sum /opt/etc/bird* > $MD5_SUM
